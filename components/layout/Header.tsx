  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between text-black dark:text-white">
        ...
        {/* MOBILE MENU BUTTON */}
        <button className="md:hidden hover:opacity-80" onClick={() => setMobileOpen(!mobileOpen)} aria-label="Toggle Menu">
          ...
          >
            <div className="flex flex-col gap-4 text-black dark:text-white">
              ...
              <button onClick={() => setMobileEarnOpen(!mobileEarnOpen)} className="flex items-center justify-between w-full hover:opacity-80">
                Earn
                <ChevronDown size={16} className={`transition-transform ${mobileEarnOpen ? "rotate-180" : ""}`} />
              </button>
