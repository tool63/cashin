...
export default function Header() {
  ...
  return (
    <header
      ref={headerRef}
      className={`${ctaGradient} fixed top-0 left-0 w-full z-50 shadow-sm`}
    >
          ...
          <Link href="/?auth=login">
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm transition ${
                activeButton === "login" ? ctaGradient : "border border-black text-black"
              }`}
            >
              Login
            </button>
        ...
        {mobileOpen && (
          ...
          >
            ...
            <div className="pt-4 flex flex-col gap-3">
              <Link href="/login">
                <button className="border border-black py-2 rounded-lg w-full">Login</button>
              </Link>
