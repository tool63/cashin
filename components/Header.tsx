  ...
  return (
    <header
      ...
      className="sticky top-0 z-50 border-b
                 bg-gradient-to-r from-yellow-400/100 via-green-400/100 to-green-500/100
                 dark:bg-gradient-to-r dark:from-yellow-400/100 dark:via-green-400/100 dark:to-green-500/100
