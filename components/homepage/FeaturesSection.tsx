  ...
  const features = [
    {
      ...
      description: "Get your earnings instantly with zero delays. Fast, secure, and reliable withdrawals.",
    },
    {
      icon: <ShieldCheck className="text-blue-500 mb-4" size={36} />,
      title: "Secure & Trusted",
      description: "Trusted by millions worldwide. Your data and earnings are fully protected.",
    },
    {
      icon: <Wallet className="text-purple-500 mb-4" size={36} />,
      title: "Multiple Payment Options",
      description: "Choose from PayPal, crypto, or gift cards. Flexible payouts that suit your lifestyle.",
    },
  ];
