  ...
  return (
    <OpeningStyle delay={0.2}>
      <section className="max-w-7xl mx-auto px-6 py-20">
        {/* Section container - matching FeaturesSection pattern */}
        <div className="text-center">
          {/* Section Heading - matching FeaturesSection style but without SectionTitle component */}
          ...
          {/* Description - matching FeaturesSection description style */}
          ...
          {/* CTA Button - styled as a card matching FeaturesSection card pattern */}
          <div className="cta-observer inline-block">
            <Link href="/signup">
              ...
              >
                ...
                {/* CTA indicator - matching FeaturesSection "Learn more" style */}
          ...
          {/* Trust indicators - matching FeaturesSection text colors */}
