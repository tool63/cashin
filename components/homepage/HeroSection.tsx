    ...
    <OpeningStyle delay={0.1}>
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center">
          ...
          {/* SUBTEXT - matching FeaturesSection description style */}
          <p className="text-lg sm:text-xl md:text-2xl mb-12 text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
            Complete tasks, surveys, watch videos, and earn rewards securely from anywhere.
          </p>

          {/* HERO CTA BUTTON - with hover effects matching card patterns */}
          ...
          {/* Optional: Trust badges or stats - matching FeaturesSection pattern */}
