...
export default function SignupPage() {
  ...
  // Build SEO data
  const seoData: SEOOutput = buildSEO(
    SEO_CONFIG.pages.signup,
    SEO_CONFIG.site.defaultLocale,
    SEO_CONFIG.site.locales
  );
      ...
      <AuthModal>
        <AuthPageWrapper title="" subtitle="">
          ...
          <RevealWithBorder 
            direction="down" 
            duration={0.6} 
            borderColor="border-gradient-to-r from-amber-500 to-rose-500"
            className="mb-8"
          >
            <div className="flex items-center justify-between p-4 bg-white/5 dark:bg-black/5 rounded-xl">
          ...
          <RevealWithBorder direction="up" duration={0.5} delay={0.1} borderColor="border-blue-500/30">
          ...
          {/* OR Divider */}
          <RevealWithBorder direction="right" duration={0.4} delay={0.2} borderColor="border-neutral-500/30">
          ...
          {!formVisible && (
            <RevealWithBorder direction="up" duration={0.5} delay={0.3} borderColor="border-green-500/30">
              <button
          ...
          {formVisible && (
            <>
              {/* Full Name Field */}
              <RevealWithBorder direction="left" duration={0.5} delay={0.1} borderColor="border-green-500/30">
              ...
              {/* Email Field */}
              <RevealWithBorder direction="right" duration={0.5} delay={0.2} borderColor="border-blue-500/30">
                <div className="relative mb-4 group">
                  <div
              ...
              {/* Password Field */}
              <RevealWithBorder direction="left" duration={0.5} delay={0.3} borderColor="border-purple-500/30">
              ...
              {showStrength && formData.password && (
                <RevealWithBorder direction="down" duration={0.4} delay={0.4} borderColor="border-purple-500/30">
                  <div className="mb-4 animate-slideDown p-4 bg-neutral-50 dark:bg-neutral-900/30 rounded-xl">
                    {/* Strength Bars */}
              ...
              {/* Submit Button */}
              <RevealWithBorder direction="up" duration={0.6} delay={0.5} borderColor="border-yellow-500/30">
                <button
          ...
          {/* Trust Badges */}
          <RevealWithBorder direction="up" duration={0.5} delay={0.6} borderColor="border-rose-500/30">
          ...
          {/* Footer */}
          <RevealWithBorder direction="up" duration={0.4} delay={0.7} borderColor="border-green-500/30">
          ...
          {/* Terms */}
          <RevealWithBorder direction="up" duration={0.4} delay={0.8} borderColor="border-amber-500/30">
