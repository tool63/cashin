...
export default function SignupPage({ onOpenAuth }: SignupPageProps) {
            ...
            <AuthPageWrapper title="" subtitle="">
              ...
              >
                ...
                <button
                  ...
                  className="text-green-500 font-medium hover:underline bg-transparent border-none p-0 cursor-pointer"
                >
                  Log In
                </button>
              </motion.p>

              {/* Terms - Keep as Links since they navigate to actual pages */}
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
