...
export default function SignupPage() {
  ...
  return (
    <>
      ...
      <div className="relative w-screen min-h-screen overflow-hidden bg-[#0B0F1A]">
        ...
        <div className="relative z-10 flex justify-center items-center min-h-screen px-4">
          <motion.div
            ...
            className="w-full max-w-md p-8 bg-white dark:bg-[#0B0F1A]/90 backdrop-blur-md rounded-3xl shadow-2xl text-white relative"
          >
      ...
      {/* Animation CSS (add to globals.css or Tailwind @layer utilities) */}
      <style jsx global>{`
        @keyframes float {
