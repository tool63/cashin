  ...
  return (
    <>
      ...
      <div className="relative w-screen min-h-screen overflow-hidden">
        ...
        {/* Gradient background */}
        <div className="absolute inset-0 bg-gradient-to-br from-yellow-400 via-green-400 to-green-500 z-0"></div>

        {/* Floating glows */}
        <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-yellow-400/40 rounded-full blur-3xl animate-float z-0"></div>
        <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-green-500/40 rounded-full blur-3xl animate-float animation-delay-2000 z-0"></div>
