...
export default function LoginPage({ onOpenAuth }: LoginPageProps) {
  ...
  return (
    <>
      ...
      <AuthPageWrapper title="" subtitle="">
        ...
        {formVisible && (
          <>
            ...
            >
              ...
              {/* Forgot Password - Changed from Link to button */}
              <button
                onClick={() => onOpenAuth?.("reset")}
                className="text-sm text-green-600 dark:text-green-400 font-medium hover:underline bg-transparent border-none p-0 cursor-pointer"
              >
                Forgot password?
              </button>
            </motion.div>
        ...
        {/* FOOTER - Changed from Link to button */}
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <button
            ...
            className="text-green-600 dark:text-green-400 font-medium hover:underline bg-transparent border-none p-0 cursor-pointer"
          >
            Sign up now
          </button>
        </motion.p>

        {/* TERMS - Keep as Links since they go to actual pages */}
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
