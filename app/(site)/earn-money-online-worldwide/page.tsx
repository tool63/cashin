...
export async function generateMetadata() {
  try {
    const seo: SEOOutput = await buildSEO({
      route: "/earn-money-online-worldwide",
    ...
    return {
      ...
      description:
        "Start earning money online from anywhere in the world. Beginner-friendly tasks, offers, and surveys to make global earnings safely.",
    };
  }
}
