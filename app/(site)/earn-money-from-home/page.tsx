...
const steps = [
  {
    ...
    description:
      "Create your account in minutes and join our trusted global community.",
  },
  {
  ...
  },
  {
    ...
    title: "Earn Rewards",
    description:
      "Redeem points for cash via PayPal, gift cards, or mobile top-ups instantly.",
  },
  {
    icon: <CheckCircle size={36} className="text-green-400" />,
    title: "Withdraw Easily",
    description:
      "Secure, fast payouts once you reach the minimum threshold.",
  },
];
...
const features = [
  {
    ...
    description: "Millions of users rely on our platform daily.",
  },
  {
    icon: <Trophy size={28} className="text-yellow-500" />,
    title: "High-Paying Offers",
    description: "Top offers that maximize your earnings.",
  },
  {
    icon: <CreditCard size={28} className="text-yellow-500" />,
    title: "Instant Payouts",
    description: "Get paid quickly via PayPal or gift cards.",
  },
  {
    icon: <User size={28} className="text-yellow-500" />,
    title: "User-Friendly Interface",
    description: "Simple, intuitive platform designed for everyone.",
  },
  {
    icon: <Gift size={28} className="text-yellow-500" />,
    title: "Mobile-Ready",
    description: "Earn anywhere with fully responsive design.",
  },
];
...
const faqs = [
  {
    q: "How do I cash out?",
    a: "Withdraw instantly via PayPal, gift cards, or mobile top-ups once you reach the minimum threshold.",
  },
  {
    q: "Is the platform secure?",
    a: "Yes! We use enterprise-grade security for all user data and transactions.",
  },
  {
    q: "Can I join from anywhere?",
    a: "Yes, our platform supports global users.",
  },
  {
    q: "Is there a minimum age?",
    a: "You must be at least 13 years old to join.",
  },
  {
    q: "Do I need to pay?",
    a: "No, registration and earning are completely free.",
  },
];
      ...
      <main className="transition-colors duration-300 bg-white dark:bg-[#0B0E1A] text-gray-900 dark:text-white min-h-screen">
        ...
        <section className="py-24 px-6 text-center relative">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl md:text-2xl mb-12 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Join thousands of users and start earning instantly from the
        ...
        <section className="text-center py-32 bg-white dark:bg-[#0B0E1A] w-full transition-colors duration-300">
          ...
          <Link href="/signup" className="cta-observer inline-block">
            ...
            >
              Start Earning Instantly <ArrowRight size={24} />
            </motion.span>
          </Link>

          <p className="mt-6 text-gray-900 dark:text-gray-300 text-lg max-w-md mx-auto">
            Join thousands of users and enjoy premium earning opportunities directly from home.
          </p>
        </section>
      </main>
    </>
