...
export default function EarnMoneyFromHome() {
  return (
    <>
      <Meta
        title="Cashog - Earn Money From Home"
        description="Start earning real money from home instantly with Cashog. Complete tasks, surveys, and high-paying offers easily."
      />
