  ...
  return (
    <>
      <Meta
        ...
        description="Cashog ensures secure, encrypted, and fraud-free earning experience for users globally."
      />

      <div className="bg-gray-50 dark:bg-[#0F111B] text-gray-800 dark:text-gray-200 transition-colors duration-300">

        {/* ================= HERO ================= */}
        <section className="py-28 px-6 text-center bg-gradient-to-br from-yellow-400/10 via-green-400/10 to-green-500/10 relative">
          <motion.h1
          ...
          <p className="max-w-2xl mx-auto text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-10">
            Enterprise-level protection, real-time fraud detection, and encrypted infrastructure designed to keep every Cashog user safe.
          </p>
          ...
          <button
            ...
            className="absolute top-6 right-6 bg-gray-200 dark:bg-gray-800 p-2 rounded-full shadow-md hover:scale-105 transition-all duration-300"
          >
            {theme === "dark" ? "🌞" : "🌙"}
          </button>
        </section>
