...
const steps = [
  {
    ...
    description: "Create your Cashog account and start earning Spotify Premium subscriptions instantly.",
  },
  {
    icon: <CreditCard size={32} className="text-green-400" />,
    title: "Complete Tasks & Offers",
    description: "Play games, watch videos, install apps, or complete surveys to earn points redeemable for Spotify Premium.",
  },
  {
    icon: <Gift size={32} className="text-yellow-400" />,
    title: "Convert Points to Spotify Premium",
    description: "Redeem your points safely and instantly for Spotify Premium codes via your Cashog account.",
  },
  {
    icon: <CheckCircle size={32} className="text-green-400" />,
    title: "Redeem Instantly",
    description: "Spotify Premium codes are delivered instantly once the redemption threshold is reached.",
  },
];

/* ================= FEATURES ================= */
const features = [
  { title: "Instant Delivery", description: "Receive Spotify Premium instantly after redeeming points." },
  ...
  { title: "Mobile-Friendly", description: "Redeem Spotify Premium on mobile, tablet, or desktop anywhere." },
  { title: "Trusted & Secure", description: "Millions of users trust Cashog for safe, verified Spotify Premium rewards." },
  { title: "24/7 Support", description: "Our support team is always ready to help with any questions." },
];

/* ================= FAQ ================= */
const faqs = [
  { q: "How do I redeem Spotify Premium?", a: "After collecting points from tasks, redeem them instantly for Spotify Premium codes via your Cashog account." },
  { q: "Can I earn from mobile?", a: "Yes! The platform is fully responsive and works on any mobile device." },
  { q: "Is signing up free?", a: "Absolutely! Creating an account and earning Spotify Premium is 100% free." },
  { q: "Are redemptions safe?", a: "Yes, all tasks and redemptions are verified and secure." },
  { q: "How long does it take to receive my code?", a: "Spotify Premium codes are delivered instantly after redeeming your points." },
];

/* ================= PAGE COMPONENT ================= */
export default function EarnSpotifyPremium() {
  ...
  return (
    <>
      <Meta
        title="Cashog - Earn Spotify Premium"
        description="Learn how to earn Spotify Premium online by completing tasks, offers, and surveys with Cashog. Instant, secure, and high-paying rewards!"
      />
      ...
      >
        ...
        {/* ================= HERO ================= */}
        <section
          className={`py-24 px-4 text-center rounded-b-3xl transition-colors duration-500 ${
            theme === "dark" ? "bg-[#111827] text-white" : "bg-gray-50 text-gray-900"
          }`}
        >
          <div className="max-w-3xl mx-auto">
            <h1 className="text-5xl sm:text-6xl font-extrabold mb-4">Earn Spotify Premium</h1>
            ...
            <p className={`text-lg sm:text-xl md:text-2xl mb-8 leading-relaxed ${
              ...
              Complete tasks, offers, and surveys to earn Spotify Premium instantly from anywhere.
            </p>
        ...
        <section className="max-w-7xl mx-auto px-4 py-20 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-12">Why Choose Cashog for Spotify Premium</h2>
        ...
        <section className={`text-center py-28 w-full transition-colors duration-300 rounded-t-3xl ${
          ...
          <h2 className="text-4xl sm:text-5xl font-extrabold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 via-green-400 to-green-500">
            Start Earning Spotify Premium Today!
          </h2>
          <Link href="/signup" className="cta-observer inline-block">
            <motion.span
              whileHover={{ scale: 1.05 }}
            ...
            >
              Redeem Spotify Premium <ArrowRight size={20} />
            </motion.span>
          </Link>
          <p className="mt-6 text-gray-300 text-lg max-w-md mx-auto transition-colors duration-300">
            Join Cashog and start earning Spotify Premium instantly from any device, anywhere.
          </p>
        </section>
