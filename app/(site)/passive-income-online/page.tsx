...
export async function generateMetadata() {
  try {
    ...
    return {
      title: "Passive Income Online - Cashog",
      description:
        "Discover ways to earn passive income online without investment. Start earning effortlessly with Cashog today.",
    };
  }
}
...
const steps = [
  {
    ...
    title: "Sign Up Free",
    description: "Create your account and unlock opportunities to earn passive income online.",
  },
  {
    icon: <ClipboardList size={36} className="text-green-400" />,
    title: "Explore Opportunities",
    description: "Find investment-free methods like surveys, apps, and tasks that generate passive income.",
  },
  {
    icon: <Zap size={36} className="text-yellow-400" />,
    title: "Earn Automatically",
    description: "Once you complete tasks or set up passive earning methods, watch your rewards grow.",
  },
  {
    icon: <CheckCircle size={36} className="text-green-400" />,
    title: "Withdraw Easily",
    description: "Cash out safely and instantly once you reach the minimum withdrawal threshold.",
  },
];

/* ================= FEATURES ================= */
const features = [
  { icon: <ShieldCheck size={28} className="text-yellow-500" />, title: "Secure & Trusted", description: "Millions trust our platform daily to earn safely online." },
  { icon: <CreditCard size={28} className="text-yellow-500" />, title: "Instant Payouts", description: "Withdraw rewards quickly via PayPal, gift cards, or mobile top-ups." },
  { icon: <Gift size={28} className="text-yellow-500" />, title: "High-Paying Methods", description: "Access methods that maximize your passive earnings." },
  { icon: <Zap size={28} className="text-yellow-500" />, title: "Automated Earnings", description: "Earn while you focus on other tasks with minimal effort." },
  { icon: <User size={28} className="text-yellow-500" />, title: "Global Access", description: "Start earning from anywhere in the world instantly." },
];

/* ================= FAQ ================= */
const faqs = [
  { q: "How do I earn passive income?", a: "Use our methods like surveys, apps, and tasks that generate income automatically." },
  { q: "Do I need to invest?", a: "No, all methods are free to use with zero upfront investment." },
  { q: "How do I withdraw earnings?", a: "Withdraw via PayPal, gift cards, or mobile top-ups safely." },
  { q: "Can I earn on mobile?", a: "Yes! Our platform is fully mobile-friendly for earning anywhere." },
  { q: "Is it safe?", a: "Absolutely. All methods are verified and trusted by millions of users." },
];

/* ================= PAGE COMPONENT ================= */
export default function PassiveIncomeOnline() {
      ...
      <main className="transition-colors duration-300 bg-white dark:bg-[#0B0E1A] text-gray-900 dark:text-white min-h-screen">
        ...
        <section className="py-24 px-6 text-center relative">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl md:text-2xl mb-12 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Explore investment-free methods to earn money online automatically and securely.
            </p>
        ...
        <section className="max-w-7xl mx-auto px-6 py-20 text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold mb-12">
            Why Choose Cashog for Passive Income
          </h2>
        ...
        <section className="text-center py-32 bg-white dark:bg-[#0B0E1A] w-full transition-colors duration-300">
          ...
          <p className="mt-6 text-gray-900 dark:text-gray-300 text-lg max-w-md mx-auto">
            Access investment-free methods and start earning passive income online safely and instantly.
          </p>
        </section>
