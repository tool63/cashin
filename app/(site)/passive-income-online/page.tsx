...
export default function PassiveIncomeOnline() {
  return (
    <>
      <Meta
        title="Cashog - Passive Income Online"
        description="Discover ways to earn passive income online without investment. Start earning effortlessly with Cashog today."
      />
