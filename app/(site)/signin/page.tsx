...
/* ================= SEO ================= */
const pageTitle = "Cashog - Login";
const pageDescription =
  "Login to Cashog and start earning rewards instantly. Access cashback, gift cards, and exclusive offers.";
    ...
    <>
      ...
      <main className="bg-white dark:bg-[#070A14] text-gray-900 dark:text-white min-h-screen transition-colors duration-300 flex flex-col items-center">
        ...
        >
          ...
          >
            Login to continue accessing high-paying offers, cashback rewards, and exclusive deals. Secure and instant login.
          </motion.p>
        </motion.section>
        ...
        >
          ...
          >
            ...
            >
              Login & Access Rewards <ArrowRight size={20} />
            </button>
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400 text-center">
              ...
              <Link href="/reset-password" className="text-green-400 font-semibold hover:underline">
                Reset
              </Link>
            </p>
          </motion.form>
