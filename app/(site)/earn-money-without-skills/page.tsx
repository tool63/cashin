...
export async function generateMetadata() {
  try {
    const seo: SEOOutput = await buildSEO({
      route: "/earn-money-without-skills",
    ...
    return {
      title: "Earn Money Without Skills - Cashog",
      description:
        "Start earning online without any prior skills. Beginner-friendly tasks, surveys, and offers to make money safely.",
    };
  }
}
...
const steps = [
  {
    ...
    title: "Sign Up Free",
    description: "Create your account quickly and start exploring no-skill required earning methods.",
  },
  {
    icon: <ClipboardList size={36} className="text-green-400" />,
    title: "Discover Simple Tasks",
    description: "Find surveys, videos, micro-tasks, and beginner-friendly offers anyone can complete.",
  },
  {
    icon: <Zap size={36} className="text-yellow-400" />,
    title: "Start Earning",
    description: "Complete tasks and earn cash, gift cards, and rewards without any prior skills.",
  },
  {
    icon: <CheckCircle size={36} className="text-green-400" />,
    title: "Withdraw Easily",
    description: "Get paid instantly via PayPal, gift cards, or mobile top-ups, hassle-free.",
  },
];

/* ================= FEATURES ================= */
const features = [
  { icon: <ShieldCheck size={28} className="text-yellow-500" />, title: "Trusted & Safe", description: "Millions of users trust our platform for secure, easy earnings." },
  { icon: <CreditCard size={28} className="text-yellow-500" />, title: "Instant Payouts", description: "Receive your rewards quickly via PayPal, gift cards, or mobile top-ups." },
  { icon: <Gift size={28} className="text-yellow-500" />, title: "Beginner-Friendly", description: "All tasks are designed for anyone, regardless of skills or experience." },
  { icon: <Zap size={28} className="text-yellow-500" />, title: "High Rewards", description: "Earn competitive rewards while completing simple online tasks." },
  { icon: <User size={28} className="text-yellow-500" />, title: "Accessible Globally", description: "Available worldwide, so anyone can start earning today." },
];

/* ================= FAQ ================= */
const faqs = [
  { q: "Do I need skills?", a: "No prior skills are needed. Anyone can start earning immediately." },
  { q: "How do I get paid?", a: "Withdraw via PayPal, gift cards, or mobile top-ups instantly." },
  { q: "Are these opportunities safe?", a: "Yes, all tasks and offers are verified and secure." },
  { q: "Can I earn on mobile?", a: "Yes, the platform is fully mobile-friendly." },
  { q: "Do I need to invest?", a: "No investment is required; all earning methods are free." },
];

/* ================= PAGE COMPONENT ================= */
export default function EarnMoneyWithoutSkills() {
      ...
      <main className="transition-colors duration-300 bg-white dark:bg-[#0B0E1A] text-gray-900 dark:text-white min-h-screen">
        ...
        <section className="py-24 px-6 text-center relative">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl md:text-2xl mb-12 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Discover easy, beginner-friendly tasks, surveys, and offers that anyone can complete to earn cash and rewards online.
            </p>
        ...
        <section className="text-center py-32 bg-white dark:bg-[#0B0E1A] w-full transition-colors duration-300">
          <h2 className="text-4xl sm:text-5xl font-extrabold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 via-green-400 to-green-500">
            Start Earning Without Skills Today
          </h2>
          ...
          <p className="mt-6 text-gray-900 dark:text-gray-300 text-lg max-w-md mx-auto">
            No skills? No problem. Start earning online with beginner-friendly tasks, offers, and surveys.
          </p>
        </section>
