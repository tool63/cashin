...
const steps = [
  {
    ...
    description: "Create your Cashog account and start earning PSN Gift Cards instantly.",
  },
  {
    icon: <CreditCard size={32} className="text-green-400" />,
    title: "Complete Tasks & Offers",
    description: "Play games, watch videos, install apps, or complete surveys to earn points redeemable for PSN Gift Cards.",
  },
  {
    icon: <Gift size={32} className="text-yellow-400" />,
    title: "Convert Points to PSN Gift Cards",
    description: "Redeem your points safely and instantly for PSN Gift Cards via your Cashog account.",
  },
  {
    icon: <CheckCircle size={32} className="text-green-400" />,
    title: "Redeem Instantly",
    description: "PSN Gift Cards are delivered instantly once the redemption threshold is reached.",
  },
];

/* ================= FEATURES ================= */
const features = [
  { title: "Instant Gift Card Delivery", description: "Receive PSN Gift Cards immediately after redeeming points." },
  ...
  { title: "Mobile-Friendly", description: "Earn PSN Gift Cards on mobile, tablet, or desktop anywhere." },
  { title: "Trusted & Secure", description: "Millions of users trust Cashog for safe, verified PSN Gift Card rewards." },
  { title: "24/7 Support", description: "Our support team is always ready to help with any questions." },
];

/* ================= FAQ ================= */
const faqs = [
  { q: "How do I redeem PSN Gift Cards?", a: "After collecting points from tasks, redeem them instantly for PSN Gift Cards via your Cashog account." },
  { q: "Can I earn from mobile?", a: "Yes! The platform is fully responsive and works on any mobile device." },
  { q: "Is signing up free?", a: "Absolutely! Creating an account and earning PSN Gift Cards is 100% free." },
      ...
      >
        ...
        >
          <div className="max-w-3xl mx-auto">
            <h1 className="text-5xl sm:text-6xl font-extrabold mb-4">Earn PSN Gift Cards</h1>
        ...
        <section className="max-w-7xl mx-auto px-4 py-20 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-12">Why Choose Cashog for PSN Gift Cards</h2>
        ...
        <section className={`text-center py-28 w-full transition-colors duration-300 rounded-t-3xl ${
          ...
          <h2 className="text-4xl sm:text-5xl font-extrabold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 via-green-400 to-green-500">
            Start Earning PSN Gift Cards Today!
          </h2>
          <Link href="/signup" className="cta-observer inline-block">
            <motion.span
              whileHover={{ scale: 1.05 }}
            ...
            >
              Redeem PSN Gift Cards <ArrowRight size={20} />
            </motion.span>
          </Link>
          <p className="mt-6 text-gray-300 text-lg max-w-md mx-auto transition-colors duration-300">
            Join Cashog and start earning PSN Gift Cards instantly from any device, anywhere.
          </p>
        </section>
