...
const steps = [
  {
    ...
    description: "Create your Cashog account and start earning Robux instantly with our platform.",
  },
  {
    icon: <CreditCard size={32} className="text-green-400" />,
    title: "Complete Tasks & Offers",
    description: "Play games, watch videos, install apps, or complete surveys to earn points redeemable for Robux.",
  },
  {
    icon: <Gift size={32} className="text-yellow-400" />,
    title: "Convert Points to Robux",
    description: "Redeem your points safely and instantly for Robux on your Roblox account.",
  },
  {
    icon: <CheckCircle size={32} className="text-green-400" />,
    title: "Receive Robux Instantly",
    description: "Robux is delivered directly to your account once the redemption threshold is reached.",
  },
];

/* ================= FEATURES ================= */
const features = [
  { title: "Instant Robux Delivery", description: "Receive Robux instantly after redeeming points." },
  ...
  { title: "Mobile-Friendly", description: "Earn Robux on mobile, tablet, or desktop anywhere." },
  { title: "Trusted & Secure", description: "Millions of users trust Cashog for safe, verified Robux rewards." },
  { title: "24/7 Support", description: "Our support team is always ready to help with any questions." },
];

/* ================= FAQ ================= */
const faqs = [
  { q: "How do I receive Robux?", a: "After collecting points from tasks, redeem them for Robux directly to your Roblox account instantly." },
  { q: "Can I earn from mobile?", a: "Yes! The platform is fully responsive and works on any mobile device." },
  { q: "Is signing up free?", a: "Absolutely! Creating an account and earning Robux is 100% free." },
  { q: "Is this safe?", a: "Yes, all tasks and redemptions are verified and secure." },
  { q: "How long does it take to receive Robux?", a: "Robux is delivered instantly after redeeming your points." },
];

/* ================= PAGE COMPONENT ================= */
export default function EarnFreeRobux() {
  return (
    <>
      <Meta
      ...
      <main className="transition-colors duration-300 bg-white dark:bg-[#070A14] text-gray-900 dark:text-white min-h-screen">
        ...
        <section className="text-center py-28 bg-[#111827] dark:bg-[#111827] w-full transition-colors duration-300 rounded-t-3xl">
          ...
          <Link href="/signup" className="cta-observer inline-block">
            ...
            >
              Redeem Robux <ArrowRight size={20} />
            </motion.span>
          </Link>
          <p className="mt-6 text-gray-300 text-lg max-w-md mx-auto transition-colors duration-300">
            Join Cashog and start earning Robux instantly from any device, anywhere.
          </p>
        </section>
