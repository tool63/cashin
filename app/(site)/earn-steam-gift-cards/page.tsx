...
export async function generateMetadata() {
  try {
    ...
    return {
      title: "Earn Steam Gift Cards Online - Cashog",
      description:
        "Earn Steam Gift Cards online by completing tasks, surveys, and offers with Cashog.",
    };
  }
}
...
const steps = [
  {
    ...
    description: "Create your Cashog account and start earning Steam Gift Cards instantly.",
  },
  {
    icon: <CreditCard size={32} className="text-green-400" />,
    title: "Complete Tasks & Offers",
    description: "Play games, watch videos, install apps, or complete surveys to earn points redeemable for Steam Gift Cards.",
  },
  {
    icon: <Gift size={32} className="text-yellow-400" />,
    title: "Convert Points to Steam Gift Cards",
    description: "Redeem your points safely and instantly for Steam Gift Cards via your Cashog account.",
  },
  {
    icon: <CheckCircle size={32} className="text-green-400" />,
    title: "Redeem Instantly",
    description: "Steam Gift Cards are delivered instantly once the redemption threshold is reached.",
  },
];

/* ================= FEATURES ================= */
const features = [
  { title: "Instant Gift Card Delivery", description: "Receive Steam Gift Cards immediately after redeeming points." },
  ...
  { title: "Mobile-Friendly", description: "Earn Steam Gift Cards on mobile, tablet, or desktop anywhere." },
  { title: "Trusted & Secure", description: "Millions of users trust Cashog for safe, verified Steam Gift Card rewards." },
  { title: "24/7 Support", description: "Our support team is always ready to help with any questions." },
];

/* ================= FAQ ================= */
const faqs = [
  { q: "How do I redeem Steam Gift Cards?", a: "After collecting points from tasks, redeem them instantly for Steam Gift Cards via your Cashog account." },
  { q: "Can I earn from mobile?", a: "Yes! The platform is fully responsive and works on any mobile device." },
  { q: "Is signing up free?", a: "Absolutely! Creating an account and earning Steam Gift Cards is 100% free." },
  { q: "Are redemptions safe?", a: "Yes, all tasks and redemptions are verified and secure." },
  { q: "How long does it take to receive my card?", a: "Steam Gift Cards are delivered instantly after redeeming your points." },
];
      ...
      >
        ...
        <section className={`text-center py-28 w-full transition-colors duration-300 rounded-t-3xl ${
          ...
          <Link href="/signup" className="cta-observer inline-block">
            ...
            >
              Redeem Steam Gift Cards <ArrowRight size={20} />
            </motion.span>
          </Link>
          <p className="mt-6 text-gray-300 text-lg max-w-md mx-auto transition-colors duration-300">
            Join Cashog and start earning Steam Gift Cards instantly from any device, anywhere.
          </p>
        </section>
