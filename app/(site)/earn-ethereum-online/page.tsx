...
const steps = [
  {
    ...
    description: "Create your Cashog account and start earning Ethereum instantly with our platform.",
  },
  {
    icon: <CreditCard size={32} className="text-green-500 dark:text-green-400" />,
    title: "Complete Tasks & Offers",
    description: "Play games, watch videos, install apps, or complete surveys to earn points that convert to Ethereum.",
  },
  {
    icon: <Gift size={32} className="text-yellow-500 dark:text-yellow-400" />,
    title: "Convert Points to Ethereum",
    description: "Redeem your points safely and instantly for Ethereum through secure wallets.",
  },
  {
    icon: <CheckCircle size={32} className="text-green-500 dark:text-green-400" />,
    title: "Withdraw Instantly",
    description: "Ethereum is delivered directly to your wallet once the redemption threshold is reached.",
  },
];

/* ================= FEATURES ================= */
const features = [
  { title: "Instant Ethereum Payouts", description: "Receive Ethereum immediately after redeeming points." },
  ...
  { title: "Mobile-Friendly", description: "Earn Ethereum on mobile, tablet, or desktop anywhere." },
  { title: "Trusted & Secure", description: "Millions of users trust Cashog for safe, verified Ethereum payouts." },
  { title: "24/7 Support", description: "Our support team is always ready to help with any questions." },
];

/* ================= FAQ ================= */
const faqs = [
  { q: "How do I withdraw Ethereum?", a: "After collecting points from tasks, redeem them for Ethereum directly to your wallet instantly." },
  ...
  { q: "Is Ethereum safe?", a: "Yes, all withdrawals are processed securely and instantly to verified wallets." },
  { q: "How long does delivery take?", a: "Ethereum payouts are delivered instantly after redemption." },
];
...
export async function generateMetadata() {
  try {
    ...
    return {
      title: "Earn Ethereum Online - Cashog",
      description:
        "Learn how to earn Ethereum online by completing tasks, surveys, and offers with Cashog.",
    };
  }
}
...
/* =========================
   Page Component
========================= */
export default function EarnEthereumOnline() {
  ...
  useEffect(() => {
    ...
    buildSEO({ route: "/earn-ethereum-online", locale: SEO_CONFIG.defaultLocale })
      .then((result) => {
      ...
      <main className="min-h-screen bg-white dark:bg-[#070A14] text-gray-900 dark:text-white transition-colors duration-300">
        ...
        <section className="py-24 px-4 text-center bg-gray-50 dark:bg-[#0F172A] transition-colors duration-300 rounded-b-3xl">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg sm:text-xl md:text-2xl mb-8 text-gray-600 dark:text-gray-300 max-w-xl mx-auto leading-relaxed">
              Complete tasks, offers, and surveys to earn Ethereum instantly from anywhere, on any device.
            </p>
        ...
        <section className="max-w-7xl mx-auto px-4 py-20 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-12">
            Why Choose Cashog for Ethereum
          </h2>
        ...
        <section className="text-center py-28 bg-gray-50 dark:bg-[#0F172A] transition-colors duration-300 rounded-t-3xl">
          ...
          <Link href="/signup" className="inline-block">
            ...
            >
              Redeem Ethereum <ArrowRight size={20} />
            </motion.span>
          </Link>

          <p className="mt-6 text-gray-600 dark:text-gray-300 text-lg max-w-md mx-auto">
            Join Cashog and start earning Ethereum instantly from any device, anywhere.
          </p>
        </section>
