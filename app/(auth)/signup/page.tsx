...
export default function SignupPage() {
  ...
  return (
    <>
      ...
      <AuthLayout>
        <div className="w-full min-h-screen flex justify-center items-center px-2 sm:px-4">
          {/* Card */}
          <div className="w-full max-w-md sm:max-w-lg lg:max-w-xl bg-white dark:bg-[#1A1F2B] rounded-3xl shadow-xl p-6 sm:p-8">
            {/* Header */}
            ...
            <SocialButtons className="mb-4 sm:mb-6" />
            ...
            {/* Links */}
            <div className="flex flex-col sm:flex-row justify-between mt-3 sm:mt-4 text-sm text-gray-600 dark:text-gray-400">
              <Link href="/login" className="hover:underline mb-1 sm:mb-0">
