...
import { Eye, EyeOff, Mail, Lock, User, Sparkles, Gift, TrendingUp } from "lucide-react";
      ...
      >
        ...
        <div className="relative p-8">
          ...
          <div className="text-center mb-8">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-yellow-400/20 via-green-400/20 to-green-500/20">
              <TrendingUp size={14} className="text-green-600" />
              <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">
                <span className="text-green-600">{counter.toLocaleString()}+</span> joined today
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            <button className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#0b0e1a] hover:bg-gradient-to-r hover:from-yellow-400/10 hover:via-green-400/10 hover:to-green-500/10 transition-all duration-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full px-4 py-3 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#070A14] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-yellow-400/50 transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative group">
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className="w-full px-4 py-3 pr-10 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#070A14] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-400/50 transition-all"
                />
                <button
                  type="button"
            ...
            <p className="text-xs text-gray-500 text-center">
              ...
              <Link href="/privacy" className="text-green-600 hover:text-yellow-600">
                Terms
              </Link>
            </p>

            {/* Sign Up Button - Matching HeroSection */}
            <button
              type="submit"
              className="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-yellow-400 via-green-400 to-green-500 text-black font-bold text-sm shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300"
            >
