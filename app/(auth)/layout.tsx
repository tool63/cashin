...
export default function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center px-4 sm:px-6 py-12 bg-gray-50 dark:bg-[#070A14] overflow-hidden">
      ...
      {/* ============================
          Premium Card with Inner Gradient Body
      ============================ */}
