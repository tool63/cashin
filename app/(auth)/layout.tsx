...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="relative w-screen min-h-screen bg-gray-50 dark:bg-[#070A14] overflow-hidden flex items-center justify-center px-4 sm:px-6">
      ...
      <div className="absolute w-96 h-96 bg-yellow-500/20 rounded-full blur-3xl animate-float animation-delay-4000 top-1/2 left-1/3 pointer-events-none z-0"></div>

      {/* ============================
          Centered Auth Card
      ============================ */}
      <div className="relative z-10 w-full max-w-xl mx-auto">{children}</div>
    </div>
  );
}
