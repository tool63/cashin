...
export default function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-50 dark:bg-[#070A14] overflow-auto">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-md mx-4 bg-white/90 dark:bg-[#0B0E1A]/90 backdrop-blur-lg border border-gray-200 dark:border-gray-700 rounded-3xl shadow-2xl p-6 sm:p-12 flex flex-col gap-6"
      >
        {children}
      </motion.div>
    </div>
