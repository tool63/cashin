// app/[country]/(marketing)/earn-ethereum-online/page.tsx
...
const getCountrySpecificKeywords = (countryName: string, countryCode: string): string[] => {
  ...
  const baseKeywords = [
    `earn ethereum online ${lowerCountry}`,
    `get free ethereum ${lowerCountry}`,
    `earn eth online ${lowerCountry}`,
    `free ethereum earning sites ${lowerCountry}`,
    `earn cryptocurrency online ${lowerCountry}`,
    `ethereum earning games ${lowerCountry}`,
    `get paid in ethereum ${lowerCountry}`,
    `earn gwei online ${lowerCountry}`,
    `free eth no investment ${lowerCountry}`,
    `ethereum rewards ${lowerCountry}`,
    `earn ethereum playing games ${lowerCountry}`,
    `crypto earning sites ${lowerCountry}`,
    `ethereum faucet ${lowerCountry}`,
    `earn $10 in ethereum ${lowerCountry}`,
    `get ethereum for free ${lowerCountry}`,
    `earn eth free ${lowerCountry}`,
    `ethereum earning apps ${lowerCountry}`,
    `free ethereum instantly ${lowerCountry}`,
    `legit ethereum earning sites ${lowerCountry}`,
    `defi earning ${lowerCountry}`,
  ];
  ...
  if (countryCode === "us") {
    baseKeywords.push(
      "earn ethereum usa",
      "free ethereum for americans",
      "crypto earnings usa",
      "ethereum rewards usa"
    );
    ...
    baseKeywords.push(
      "earn ethereum canada",
      "free ethereum canada",
      "crypto earnings canada",
      "ethereum rewards canada"
    );
  } else if (countryCode === "au") {
    baseKeywords.push(
      "earn ethereum australia",
      "free ethereum australia",
      "crypto earnings australia",
      "ethereum rewards australia"
    );
  } else if (countryCode === "de") {
    baseKeywords.push(
      "ethereum verdienen deutschland",
      "kostenlos ethereum bekommen",
      "krypto verdienen",
      "ethereum belohnungen"
    );
...
export async function generateMetadata({
  ...
  try {
    translation = await loadSectionTranslation(language, "earn-ethereum-online");
  } catch (error) {
    // Use defaults
  }
  ...
  const seoTitle = replaceCountry(
    rawTitle,
    `Earn Ethereum Online in ${countryName} - Get Free ETH Rewards | Cashog`
  );

  const seoDescription = replaceCountry(
    rawDescription,
    `Earn Ethereum online in ${countryName} by playing games, completing offers & DeFi tasks. Get paid in ETH instantly. Start earning cryptocurrency for free today!`
  );
  ...
  return {
    ...
    keywords,
    alternates: {
      canonical: `https://cashog.com/${country}/earn-ethereum-online`,
    },
    openGraph: {
      title: seoTitle,
      description: seoDescription,
      url: `https://cashog.com/${country}/earn-ethereum-online`,
      siteName: "Cashog",
      type: "website",
...
export default async function EarnEthereumOnlinePage({
  params,
}: {
  params: Promise<{ country?: string }> | { country?: string };
}) {
  ...
  // Load translations
  const tData = await loadSectionTranslation(language, "earn-ethereum-online");
  ...
  const title = t(rawTitle, `Earn Ethereum Online in ${countryName} - Get Free ETH`);
  const description = t(rawDescription, `Earn Ethereum online in ${countryName} by playing games and completing offers.`);

  const structuredData = generateJsonLd({
    path: `/${country}/earn-ethereum-online`,
    title,
    description,
    type: "low",
  });
  ...
  const heroData = {
    title: t(tData?.hero?.title, `Earn Ethereum Online in ${countryName}`),
    subtitle: t(
      tData?.hero?.subtitle,
      `Get free Ethereum (ETH) by playing games, completing offers & DeFi tasks. Join 100,000+ users who've already earned 50,000+ ETH in cryptocurrency rewards!`
    ),
  };

  const statsData = {
    title: t(tData?.statsTitle, "Trusted by Thousands"),
    ethEarned: tData?.stats?.ethEarned || "50,000+",
    ethEarnedLabel: tData?.stats?.ethEarnedLabel || "ETH Earned",
    avgPayout: tData?.stats?.avgPayout || "$30",
    ...
    totalPaid: tData?.stats?.totalPaid || "$150M+",
  ...
  const faqData = {
    title: t(tData?.faq?.title, `Earn Ethereum Online in ${countryName} - FAQ`),
  ...
  const finalData = {
    title: t(tData?.final?.title, `Ready to Start Earning Ethereum in ${countryName}?`),
    subtitle: t(
      tData?.final?.subtitle,
      `Join 100,000+ users already earning Ethereum in ${countryName}. Sign up for free and start earning the world's leading smart contract platform today!`
    ),
  };
      ...
      <CircleBorder>
        <OpeningStyle delay={0.1}>
          ...
          >
            ...
            <PrimaryCTA
              href="/signup"
              translationKey="start_earning_ethereum"
              observer={true}
            />
          </section>
        </OpeningStyle>
            ...
            >
              <div className="text-center mb-16">
                <h2
                  ...
                  className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4"
                >
                  {t(tData?.methodsTitle, "Ways to Earn Ethereum Online")}
                </h2>
                <div
                  className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto mt-4 rounded-full"
                  aria-hidden="true"
            ...
            >
              <div className="text-center mb-16">
                <h2
                  ...
                  className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4"
                >
                  {t(tData?.featuredOffersTitle, "Top Ethereum Earning Opportunities")}
                </h2>
                <div
                  className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto mt-4 rounded-full"
                  aria-hidden="true"
                />
                <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mt-6">
                  {t(tData?.featuredOffersSubtitle, "Limited spots - start earning ETH today")}
                </p>
              </div>
            ...
            >
              <div className="text-center mb-16">
                <h2
                  ...
                  className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4"
                >
                  {t(tData?.benefitsTitle, "Why Earn Ethereum With Us")}
                </h2>
                <div
                  className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto mt-4 rounded-full"
                  aria-hidden="true"
            ...
            >
              <div className="text-center mb-16">
                <h2
                  ...
                  className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4"
                >
                  {t(tData?.tipsTitle, "Tips to Maximize Your Ethereum Earnings")}
                </h2>
                <div
                  className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto mt-4 rounded-full"
                  aria-hidden="true"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                {tipsData.map((tip) => (
                  <div key={tip.number} className="text-center">
                    <div
                      className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4 shadow-lg"
            ...
            >
              <div className="text-center mb-16">
                <h2
                  ...
                  className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4"
                >
                  {t(tData?.testimonialsTitle, "Real Users, Real Ethereum Earnings")}
                </h2>
                <div
                  className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto mt-4 rounded-full"
                  aria-hidden="true"
                ...
                {testimonialsData.map((testimonial, index) => (
                  ...
                  >
                    ...
                    <p className="text-blue-600 dark:text-blue-400 font-semibold text-sm">
                      Earned {testimonial.earnings} in Ethereum
                    </p>
                  </div>
                ))}
              </div>
